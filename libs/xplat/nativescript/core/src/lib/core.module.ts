...
import { fontAwesomeIcons } from '@tin/xplat/nativescript/utils';
...
export class TinCoreModule {
  constructor(
    @Optional()
    @SkipSelf()
    parentModule: TinCoreModule
  ) {
    throwIfAlreadyLoaded(parentModule, 'TinCoreModule');
  }
}
